                ...
                <div class="kt-portlet__body">
                    ...
                    <form action="{{route('settings.settings.update')}}" method="POST" id="update_setting_form" class="m-form m-form--fit m-form--label-align-right m-form--group-seperator" data-async data-callback="updateContactCallback" data-parsley-validate enctype="multipart/form-data">
                        ...
                        <div class="m-portlet__body">
                            ...
                            <div class="row mb-3">
                                <div class="col-sm-12 col-md-12 col-lg-6 mt-5">
                                    <label class="h6" for="years_experience">{{__('settings::settings.years_experience')}}</label>
                                    <input name="years_experience" id="years_experience" type="text" class="form-control" value="{{$setting->years_experience}}" placeholder="{{__('settings::settings.years_experience')}}"  data-parsley-trigger="change focusout">
                                </div>
                                <div class="col-sm-12 col-md-12 col-lg-6 mt-5">
                                    <label class="h6" for="happy_clients">{{__('settings::settings.happy_clients')}}</label>
                                    <input name="happy_clients" id="happy_clients" type="text" class="form-control" value="{{$setting->happy_clients}}" placeholder="{{__('settings::settings.happy_clients')}}"  data-parsley-trigger="change focusout">
                                </div>
                            </div>
                                    <div class="row mb-3">
                                <div class="col-sm-12 col-md-12 col-lg-6 mt-5">
                                    <label class="h6" for="projects_completed">{{__('settings::settings.projects_completed')}}</label>
                                    <input name="projects_completed" id="projects_completed" type="text" class="form-control" value="{{$setting->projects_completed}}" placeholder="{{__('settings::settings.projects_completed')}}"  data-parsley-trigger="change focusout">
                                </div>
                                <div class="col-sm-12 col-md-12 col-lg-6 mt-5">
                                    <label class="h6" for="commitment">{{__('settings::settings.commitment')}}</label>
                                    <input name="commitment" id="commitment" type="text" class="form-control" value="{{$setting->commitment}}" placeholder="{{__('settings::settings.commitment')}}"  data-parsley-trigger="change focusout">
                                </div>
                            </div>
