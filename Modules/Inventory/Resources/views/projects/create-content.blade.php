                                                                                    ...
                                                                                    <div class="col-lg-6">
                                                                                        ...
                                                                                        <div class="row">
                                                                                            <div class="box col-6">
                                                                                                ...
                                                                                                <input type='file' name="file" class="image-input" image-id="blah-0" onchange="readURL(this);"id="attachments" data-parsley-trigger="change focusout" />
                                                                                         </div>
                                                                                            <div class="card col-6" >
                                                                                                <div class="html5lightbox" title="" data-group="image_group" href="#" data-width="1200" data-height="1200" title="{{trans('inventory::inventory.view_image')}}">
                                                                                                    <img id="blah-0" class="card-img-top w-100 image-preview" alt="{{trans('inventory::inventory.image')}}">
                                                                                                </div>
                                                                                            ...
                                                                                            <label for="image"><strong>{{__('settings::settings.image_dimensions')}}:600 × 800 px</strong></label>

                                                                                        </div>
                                                                                    </div>
                                                                                    <div class="col-md-2 col-sm-2">
                                                                                        <a href="javascript:;" data-repeater-delete class="btn btn-brand data-repeater-delete" onclick="$('.delete-attachments').append(`<input type='hidden' name ='delete_attachments[]'>`)">
                                                                                            <i class="fa fa-times"></i>
                                                                                        </a>
                                                                                    </div>
                                                                                </div>
