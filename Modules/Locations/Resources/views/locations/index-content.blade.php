            ...
            <div class="kt-portlet kt-portlet--mobile">
                <div class="kt-portlet__head kt-portlet__head--lg">
                    <div class="kt-portlet__head-label">
                        ...
                        <div class="kt-subheader__breadcrumbs mx-3">
                            @if (isset($breadcrumbs) && !is_null($breadcrumbs))
                            @foreach($breadcrumbs as $i=> $location)
                            <span class="kt-subheader__breadcrumbs-separator"></span>
                            <a href="{{route('locations.index',$location["id"])}}" data-8xload class="kt-subheader__breadcrumbs-link ">{{$location["name"]}}</a>
                            @endforeach
                            @endif
