...
<section class="view-page pb-5" itemscope itemtype="http://schema.org/Product">
    <div class="container">
                    ...
                    <div class="sticky-holder sticky-top">
                        <nav class="navbar p-0">
                            <ul class="nav nav-pills spy-links">
                                ...
                                @endif
                                @if ($single_unit->description || $single_unit->price || $single_unit->area || $single_unit->bedroom || $single_unit->bathroom || $single_unit->offering_type || $single_unit->furnishing_status || $single_unit->finishing_type || $single_unit->city)
                                    <li class="nav-item">
                                        <a class="nav-link spy-link d-inline-flex align-items-center gap-1"
                        ...
                        <div class="tab-content">
                            <div class="tab-pane fade show active" id="tab-1" role="tabpanel">
                                <div class="gallery-large-holder position-relative">
                                    @if ($single_unit->project)
                                        <div class="dev-logo">
                                            ...
                                            @empty
                                                <img class="img-thumbnail" onerror="this.remove()"
                                                    src="{{ URL::asset('front/img/logo_1.png') }}"
                                ...
                                @if (count($single_unit->attachments))
                                    <div class="swiper gallery-large" style="height: 450px;width: 600px">
        ...
        <div class="col-lg-3 mt-3 mt-lg-0">
            <div class="view-page__block sticky-md-top">
                <aside class="sidebar">
                    ...
                    <ul class="item-contacts justify-content-md-end">
                        ...
                        <li>
                            <a href="#contact-modal" class="open-contact-modal visit" data-bs-toggle="modal"
                                ...
                                <span class="d-none d-sm-block" data-title="Request A visit!">Request a
                                    visit</span>
                            </a>
                        </li>
                    </ul>
 ...
 <div class="single-list">
     <div class="container">
         <div class="go-back">
             ...
             <a href="{{ route('front.properties') }}"><i class="breadcrumb-arrow"></i>{{ __('main.properties') }}</a>
             {{-- @if ($single_unit->city)

                 <a
                     href="{{ route('front.areas.show', ['id' => $single_unit->city->id, 'slug' => str_slug($single_unit->city->default_value)]) }}"><i
                         class="breadcrumb-arrow"></i>{{ $single_unit->city->name }}</a>
             @endif --}}
             <span><i class="breadcrumb-arrow"></i>{{ $single_unit->title }}</span>
         </div>
         {{-- <div class="go-back">
             <nav aria-label="breadcrumb">
                 <div class="container">
         ...
         <div class="flex-box">
             ...
             <div class="box-slider">
                 <div class="slider-for">
                     @foreach ($single_unit->attachments as $attachment)
                         <div class="slider-parent-image">
                             <img src="{{ $attachment->url ? $attachment->url : asset('front/img/home1.jpg') }}"
                                 itemprop="{{ $single_unit->title }}" alt="{{ $single_unit->title }}">
                         </div>
                     @endforeach
                 </div>
             ...
             <div class="single-list-content">
                 ...
                 <div class="row property-details">
                     <div>
                         ...
                         @if ($single_unit->bedroom)
                             <p><i class="fas fa-bed"></i>
                                 {{ __('inventory::inventory.bedrooms') }}:{{ $single_unit->bedroom }}
                             </p>
                         @endif
                         ...
                         @if ($single_unit->bathroom)
                             <p><i class="fas fa-toilet"></i>
                                 {{ __('inventory::inventory.bathrooms') }}:{{ $single_unit->bathroom }}
                             </p>
                         @endif
                     ...
                     <div>
                         ...
                         @if ($single_unit->furnishing_status)
                             <p><i class="fas fa-th"></i>
                                 {{ __('inventory::inventory.furnishing_status') }}:{{ $single_unit->furnishing_status }}
                             </p>
                         @endif
                         ...
                         @if ($single_unit->finishing_type)
                             <p><i class="fas fa-th"></i>
                                 {{ __('inventory::inventory.finished_status') }}:{{ $single_unit->finishing_type }}
                             </p>
                         @endif
                     </div>

                 </div> <!-- close row property-details -->
                 ...
                 @if ($single_unit->amenities || $single_unit->facilities)
                     ...
                     <h3>{{ __('inventory::inventory.facilities_and_amenities') }}</h3>
                                 ...
                                 <div class="accordion-item">
                                     <h2 class="accordion-header">
                                         <button class="accordion-button" type="button" data-bs-toggle="collapse"
                                             data-bs-target="#acc-1" aria-expanded="true">
                                             {{ __('inventory::inventory.amenities') }}
                                         </button>
                                     </h2>
                         ...
                         @if ($single_unit->facilities)
                             <div class="col-md-6">
                                 <div class="accordion-item">
                                     <h2 class="accordion-header">
                                         <button class="accordion-button" type="button" data-bs-toggle="collapse"
                                             data-bs-target="#acc-2" aria-expanded="true">
                                             {{ __('inventory::inventory.facilities') }}
                                         </button>
                                     </h2>
                                     <div id="acc-2" class="accordion-collapse collapse show">
                     ...
                     </div> <!-- close property-features -->
                 @endif

                 <h3>{{ __('inventory::inventory.floor_plans') }}</h3>
                 <div id="accordion">

                     @if ($single_unit->master_plans)
                         <div class="accordianheader">
                             <h4>{{ __('inventory::inventory.master_plans') }}: &nbsp; <i></i></h4>
                         </div>
                     ...
                     @if ($single_unit->floor_plans)
                         <div class="accordianheader">
                             <h4>{{ __('inventory::inventory.floor_plans') }}: &nbsp; <i></i></h4>
                         </div>
                         <div class="accordianbody">
                             {{-- <img src="img/plan-sketch.jpg" alt="" /> --}}
                             <div class="swiper gallery-plans-slider">
