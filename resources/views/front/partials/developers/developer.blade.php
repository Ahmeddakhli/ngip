          ...
          <div class="col-lg-2 col-md-3">
            <div class="dev-logo">
                @forelse($developer['developer']->attachments as $attachment)
                    ...
                    @endif
                @empty
                    <img class="img-thumbnail d-block m-auto" width="150" src="{{ URL::asset('front/img/logo_1.png') }}"
    ...
    <div class="container">
        ...
        <div class="flex-items">
            <div class="go-back">
                ...
                <span><i class="breadcrumb-arrow"></i>{{ $developer['developer']->developer }}</span>
            </div>
        </div>
        <!-- open container -->
        <div class="developer-single-page">
            <div href="#" class="our-developers">
                @forelse($developer['developer']->attachments as $attachment)
                    @if ($loop->index == 0)
                ...
                @endif
            @empty
                <img class="img-thumbnail d-block m-auto" width="150"
                    src="{{ URL::asset('front/img/logo_1.png') }}" alt="{{ $developer['developer']->developer }}">
            @endforelse
        </div>
        <div class="content-details">
            <h1 class="title-developer"> {{ $developer['developer']->developer }} </h1>
            {!! $developer['developer']->description !!}
        </div>
    </div>


    <h2 class="caption" class="capitalize"><a href="#">{{ $developer['developer']->developer }}
            {{ __('main.projects') }}</a></h2>
    ...
    <div class="flex-box">
        <!-- open flex-box -->
            ...
            <div class="project">
                ...
                <a href="{{ route('front.singleProject', ['id' => $project->id, 'slug' => $project->slug]) }}">
                    ...
                    @endif
                @empty
                    <img onerror="" src="{{ asset('front/img/logo_1.png') }}"
                        alt="{{ $project->project }}">
                @endforelse
                <div class="overlay">
                    <!-- open overlay -->
