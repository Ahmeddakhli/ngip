...
@endpush --}}
     <div class="our-projects re-sale">
         <!-- open re-sale -->
         <div class="container">
             <!-- open container -->
             <div class="flex-items">
                 <div class="go-back"><a href="{{ route('front.home') }}"><i
                     ...
                     <span><i class="breadcrumb-arrow"></i>{{ __('main.properties') }}</span>
                 </div>
             ...
             <h2 class="caption" class="capitalize"><a href="#">{{ __('main.properties') }}</a></h2>

             <div class="flex-box">
                 <!-- open flex-box -->
                 @foreach ($properties as $property)
                     <div class="project wow bounceInUp" data-wow-duration="1s">
                         <a class="hidden-image-link special-image-card"
                             href="{{ route('front.singleUnit', ['id' => $property->id, 'title' => str_slug($property->default_title)]) }}">
                             ...
                             @endif
                         @empty
                             <meta itemprop="image" content="{{ URL::asset('front/img/ngib-not-found.png') }}" />
                             <img class="unit-img placeholder-img" onerror="this.remove()"
                                 src="{{ URL::asset('front/img/ngib-not-found.png') }}" alt="{{ $property->title }}"
                                 itemprop="image">
                         @endforelse
                         <div class="overlay">
                             <!-- open overlay -->
                             <div class="details resale-info">
                                 <!-- open details -->
                                 <div class="title">
                                     <div class="title-top">
                                         <h3 class="capitalize">{{ $property->title }} </h3>
                                         <span> <strong>{{ $property->area }} {{ $property->area_unit }}
                                             </strong></span>
                                     </div>
                                     <div class="title-bottom">
                                         <span> {{ $property->bedroom }}<i class="fas fa-bed"></i></span>
                                         <span>{{ $property->bathroom }}<i class="fas fa-toilet"></i></span>
                                     </div>
                                 </div>
                                 <div class="price-details">
                                     <p class='price'> {{ __('main.price') }}</p>
