...
@push('meta')
    ...
    <meta itemprop="name"
        content="{{ $single_project->meta_title ? $single_project->meta_title : $single_project->project }}" />
    <meta itemprop="image" content="{{ URL::asset('/front/img/logo_1.png') }}">
    ...
    <meta property="og:title"
        content="{{ $single_project->meta_title ? $single_project->meta_title : $single_project->project }}" />
    {{-- <meta property="og:image" content="{{ URL::asset('/front/img/logo_1.png') }}"> --}}
    <meta property="og:image"
        content="{{ $single_project->attachments[0]->url ? $single_project->attachments[0]->url : URL::asset('/front/img/logo_1.png') }}">
    ...
    <div class="single-list">
        <div class="container">
            <div class="go-back">
                ...
                <span class='parent'><i class="breadcrumb-arrow"></i>{{ __('main.projects') }}</span>
                <span><i class="breadcrumb-arrow"></i>{{ $single_project->project }}</span>
            </div>
                        ...
                        @foreach ($single_project->attachments as $attachment)
                            <div class="slider-parent-image">
                                <img src="{{ $attachment->url ? $attachment->url : asset('front/img/home1.jpg') }}"
                                    itemprop="{{ $single_project->project }}" alt="{{ $single_project->project }}">
                            </div>
                        @endforeach
                    </div>
                ...
                <div class="single-list-content">
                    ...
                    <div class="row">
                        <div class="left">
                            ...
                            <div class="right">
                              {{ __('main.starting_price') }} : <a href="#">{{ $single_project->price_from }}EGP</a>
                           </div>
                           <div class="right">
                            {{ __('main.area_from') }} : <a href="#">{{ $single_project->area_from }}M</a>
                         </div>
                        </div>
