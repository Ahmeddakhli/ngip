...
<meta itemprop="image" content="{{isset($attach_value) ? $attach_value : URL::asset('front/img/logo_1.png')}}">
...
<meta property="og:image" content="{{isset($attach_value) ? $attach_value : URL::asset('front/img/logo_1.png')}}">
