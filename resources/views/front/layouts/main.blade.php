...
<!DOCTYPE html>
<html lang="{{  App::getLocale()}}" id="CurrentLang" dir="{{ $dir }}">
...
<body class="@if (App::getLocale() == 'ar') dir-rtl @endif">
    ...
    <nav class="chat-actions">
        ...
        <div class="social-links">
            ...
            @if ($setting->active_messanger_icon)
                <a href="{{count($socials) ? collect($socials)->first()->link : '#'}}" class="social-link messenger-link" title='Messenger' style="--delay: 0.1s"
    ...
    <main class="main-content">
        ...
        <div class="loading" id="loading-animation">
            <lottie-player src="https://lottie.host/0b24e256-33b0-418b-8352-d7cf6ea83798/PP2TzhsDYL.json"
        ...
        @if (Route::currentRouteName() == 'front.home')
                    ...
                    <div class="row">
                        <div class="menu-logo">
                            <a href="{{ route('front.home') }}">
                                <img id="logo" src="{{ asset('front/img/logo_1.png') }}" alt="logo">
                            </a>
                        </div>
                        <div class="contnet">
            ...
            <div class="logo wow">
                <a href="{{ route('front.home') }}">
                    <img src="{{ asset('front/img/logo_1.png') }}" alt="" />
                </a>
            </div>
        @endif
        ...
        <!-- notification & social messages button -->
        ...
        <div class="fixed-left-buttons">
            ...
            <nav class="social-msg">
                <input type="checkbox" class="menu-open" name="menu-open" id="menu-open" />
                <label class="menu-open-button" for="menu-open">
                    <i class="far fa-comment-dots"></i>
                </label>
                @if ($setting->active_messanger_icon)
                    <a href="{{ count($socials) ? collect($socials)->first()->link : '#' }}" class="menu-item messenger"
                        title='Messenger' style="--delay: 0.1s" target="_blank" rel="noopener" noreferrer>
                        <i class="fab fa-facebook-messenger"></i>
                    </a>
                @endif
                @if ($setting->active_whatsapp_icon)
                    <a href="https://api.whatsapp.com/send?phone={{ $whatsapp }}" class="menu-item whatsapp"
                        title='WhatsApp' style="--delay: 0.15s" target="_blank" rel="noopener" noreferrer>
                        <i class="fab fa-whatsapp"></i>
                    </a>
                @endif
            </nav>
