        ...
        <div class="col-lg-11">
          <div class="row g-2">
            ...
            <div class="col-12 col-md-6">
              <input class="form-control" type="text" name="q" value="{{request('q')}}" placeholder="Area, Project, Developer">
            </div>
...
<form class="search-form" action=" {{ isset($url) ? $url : route('front.properties') }}" method="GET">
    ...
    <div class="select wow fadeInUp" data-wow-duration="2s" data-wow-delay="1s">
        ...
        <select style="width: 150px" placeholder="{{ __('inventory::inventory.select_offering_type') }}" name="offering_types[]" >
                <option value="">{{ __('inventory::inventory.select_offering_type') }}</option>
                @foreach ($offering_types as $offering_type)
                    <option value="{{ $offering_type->id }}"
                        @if (request('offering_types') && in_array($offering_type->id, request('offering_types'))) selected @endif>{{ $offering_type->offering_type }}
                    </option>
                @endforeach
        ...
        <select style="width: 150px" class=""
            placeholder="{{ __('inventory::inventory.bedrooms') }} & {{ __('inventory::inventory.bedrooms') }}"
            name="bathrooms[]">
            <option value="">{{ __('inventory::inventory.bathroom') }}</option>
        ...
        <select style="width: 150px" class=""
            placeholder="{{ __('inventory::inventory.bedrooms') }} & {{ __('inventory::inventory.bedrooms') }}"
            name="bedrooms[]">
            <option value="">{{ __('inventory::inventory.bedrooms') }}</option>
