{{--
<div class="card-item project-card swiper-slide item">
    <div class="card-item__content">
        ...
        <div class="card-item__header">
            @if ($project->developer)
                <a class="dev-logo"
                    ...
                    <img src="{{ asset('front/img/home4.jpg') }}" alt="" />
        ...
        href="#"
        target="_blank" itemprop="url">
            <img onerror="this.remove()" src="{{ URL::asset('front/img/logo_1.png') }}" alt="No Developer" itemprop="logo">
        </a>
        @endif
        ...
        <div class="card-img">
            ...
            @endif
        @empty
            <img onerror="this.remove()" src="{{ URL::asset('front/img/logo_1.png') }}" alt="{{ $project->project }}">
        @endforelse
    </div>
</div>
    ...
    <ul class="card-info">
        ...
        @if ($project->number_of_installments_from)
            <li>
                ...
                <strong>{{ $project->number_of_installments_from }}</strong> Months
            </li>
        @endif
...
<div class="swiper-slide item" >
    <a class="hidden-image-link" href="{{ route('front.singleProject', ['id' => $project->id, 'slug' => $project->slug]) }}" target="_blank"
