...
<head>
	...
	<link rel="apple-touch-icon" href="{{asset('front/img/logo_1.png')}}">
	<link rel="apple-touch-icon" sizes="57x57" href="{{asset('front/img/logo_1.png')}}">
	<link rel="apple-touch-icon" sizes="60x60" href="{{asset('front/img/logo_1.png')}}">
	<link rel="apple-touch-icon" sizes="72x72" href="{{asset('front/img/logo_1.png')}}">
	<link rel="apple-touch-icon" sizes="76x76" href="{{asset('front/img/logo_1.png')}}">
	<link rel="apple-touch-icon" sizes="114x114" href="{{asset('front/img/logo_1.png')}}">
	<link rel="apple-touch-icon" sizes="120x120" href="{{asset('front/img/logo_1.png')}}">
	<link rel="apple-touch-icon" sizes="144x144" href="{{asset('front/img/logo_1.png')}}">
	<link rel="apple-touch-icon" sizes="152x152" href="{{asset('front/img/logo_1.png')}}">
	<link rel="apple-touch-icon" sizes="180x180" href="{{asset('front/img/logo_1.png')}}">
	<link rel="icon" type="image/png" sizes="192x192" href="{{asset('front/img/logo_1.png')}}')}}">
	<link rel="icon" type="image/png" sizes="32x32" href="{{asset('front/img/logo_1.png')}}">
	<link rel="icon" type="image/png" sizes="96x96" href="{{asset('front/img/logo_1.png')}}">
	<link rel="icon" type="image/png" sizes="16x16" href="{{asset('front/img/logo_1.png')}}"> -->
	<style>
		/* width */
		::-webkit-scrollbar {
			width: 8px
			...
			<div class="m-grid__item m-grid__item--fluid	m-login__wrapper">
				<div class="m-login__container">
					<div class="m-login__logo" style="margin-bottom:2.5rem">
						<a href="#">
							<img src="{{URL::asset('front/img/logo_1.png')}}" style="width:60%">
						</a>
					</div>
